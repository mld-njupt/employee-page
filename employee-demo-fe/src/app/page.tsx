    ...
    <div className="font-sans bg-indigo-100">
      ...
      <div className="container mx-auto py-8 px-6 ">
        <div className="max-w-5xl mx-auto space-y-6">
          <MainCard employee={employee}></MainCard>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              <AboutCard employee={employee}></AboutCard>
              <ExperienceCard employee={employee}></ExperienceCard>
            </div>
            <div className="space-y-6">
              <EducationCard employee={employee}></EducationCard>
              <SkillsCard employee={employee}></SkillsCard>
            </div>
          </div>
        </div>
      </div>
